...
| FEAT-001 | UX/UI (Baseline/System) | CRUD | تجهيز واجهة تعمل بدون تفاعل (baseline UI system) كأساس للمشروع | جميع المستخدمين | FR-001 | 08-ui/baseline-system | P0 | Planned |
...
> لا تحذف هذا القالب؛ فقط انسخه أسفله لكل ميزة جديدة.
